...
> 本文档面向"动漫与二次元谷子"定制电商与内容分享平台的规划与需求设计。
...
#### 自动启动脚本 (推荐) / Auto Start Script (Recommended)

项目根目录提供了一键启动脚本，同时启动后端和前端开发服务器：
...
- ✅ 启动后端 FastAPI 服务器 (http://localhost:8000)
